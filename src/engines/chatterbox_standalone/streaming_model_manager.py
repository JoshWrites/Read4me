...
from .language_models import get_available_languages, get_model_config
from .stateless_wrapper import StatelessChatterBoxWrapper

try:
    from utils.models.language_mapper import get_language_mapper
except ImportError:
    def get_language_mapper(engine: str):
        class _Mapper:
            def get_model_for_language(self, lang, default="English"):
                return default
        return _Mapper()
